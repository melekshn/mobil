...
import 'package:disleksi_surum/components/saw.dart';
import 'package:disleksi_surum/components/utils.dart';
...
class Player extends SpriteAnimationGroupComponent
  ...
  SpriteAnimation _spriteAnimation(String state, int amount) {
    return SpriteAnimation.fromFrameData(
      game.images.fromCache(
          'pixeladventure/Main Characters/$character/$state (32x32).png'),
  ...
  SpriteAnimation _specialSpriteAnimation(String state, int amount) {
    return SpriteAnimation.fromFrameData(
      game.images.fromCache('pixeladventure/Main Characters/$state (96x96).png'),
      SpriteAnimationData.sequenced(
        amount: amount,
        stepTime: stepTime,
