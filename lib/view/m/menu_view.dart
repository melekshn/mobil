...
class MMenuView extends StatelessWidget {
  const MMenuView({super.key});
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildHomeButton(context, 'M Avcısı', Icons.search, () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => Ders1(list: listem['m']!,index: 0,),
                      ),
                    );
                  }),
                  _buildHomeButton(context, 'M mi N mi ?', Icons.question_mark, () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => XHarfiSayfaKontrol(list: listem['m2']!),
                      ),
                    );
                  }),
                  _buildHomeButton(context, 'Farklı olanı bul!', Icons.priority_high, () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => PDers3(harf: 'm',img: ['m','n','n','n','n','n'],),
                      ),
                    );
                  }),
                  _buildHomeButton(context, 'Ağaçtan elma topla!', Icons.touch_app, (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const HarfToplaPage(hedefHarf: "m", harfListesi: ['m', 'u', 'n', 'm', 'u', 'n', 'n', 'm', 'n', 'm', 'm'],),
                      ),
                    );
                  }),
                  _buildHomeButton(context, 'Balon Oyunu!', Icons.touch_app, (){
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const HarfBulPage(hedefHarf: 'm', harfListesi: ['m', 'u', 'n', 'm', 'u', 'n', 'n', 'm', 'n', 'm', 'm'],)
                      ),
                    );
                  }),
                ],
