import 'dart:math';
import 'package:disleksi_surum/view/time_and_yon/sonbahar_view.dart';
              ...
              children: [
                Flexible(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(
                      'assets/images/mevsim/ilkbahar.jpeg', // dosya adını düzelt
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
                Flexible(
                  ...
                  child: Column(
                    ...
                    children: [
                      _buildSeasonButton(mevsim[0], 'ilkbahar', context),
                      const SizedBox(height: 15),
                      _buildSeasonButton(mevsim[1], 'ilkbahar', context),
                      const SizedBox(height: 15),
                      _buildSeasonButton(mevsim[2], 'ilkbahar', context),
                      const SizedBox(height: 15),
                      _buildSeasonButton(mevsim[3], 'ilkbahar', context),
                    ],
                  ),
                ),
              ],
